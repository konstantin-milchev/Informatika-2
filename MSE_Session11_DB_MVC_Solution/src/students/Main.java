...
import students.database.nosql.NoSQL;
import students.database.orm.mysql.MySQLHibernate;
import students.database.orm.nosql.NoSQLMorphia;
...
public class Main {
	...
	public static void main(String[] args) throws SQLException {
		 ...
		 * that certain functionalities haven't been implmented yet.
...
//		mysql.insertDataset(new Assistent(5050, "jan", "MSE", 2125));
//		mysql.deleteDataset(new Assistent(5050, "jan", "MSE", 2125));
//		List<Assistent> assis = mysql.getAllDatasets();
...
//		}
		...
		//TODO: TASK9: Test your implementation in this main class!
